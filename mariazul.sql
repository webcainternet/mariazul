...
--
-- Host: localhost:3306
-- Generation Time: Apr 06, 2015 at 04:35 PM
...
(2, 2, 'Fernando', 'Mendes', '', '', '', 'Lomas Valentinas', '', 'São Caetano do Sul', '09560-260', 30, 464);
...
(4, 'Real', 'BRL', 'R$ ', '', '2', 1.00000000, 1, '2015-04-06 02:16:25');
...
(2, 0, 'Fernando', 'Mendes', 'fernando.mendes@webca.com.br', '11976495157', '', '15e7c98cdcf88e5acdf376ba716d88f2b10ce9cb', 'df2419b62', 'a:0:{}', '', 0, 2, 1, '127.0.0.1', 1, 1, '', '2015-04-06 02:37:23');
...
(2, 2, '127.0.0.1', '2015-04-06 02:37:24');
...
) ENGINE=MyISAM AUTO_INCREMENT=5137 DEFAULT CHARSET=utf8;
...
(5111, 0, 'config', 'config_seo_url', '0', 0),
...
(5057, 0, 'config', 'config_invoice_prefix', 'Mariazul', 0),
...
(5025, 0, 'config', 'config_title', 'Mariazul', 0),
(5026, 0, 'config', 'config_meta_description', 'Mariazul', 0),
...
(5020, 0, 'config', 'config_owner', 'Mariazul', 0),
(5019, 0, 'config', 'config_name', 'Mariazul', 0),
(5114, 0, 'config', 'config_maintenance', '0', 0),
(5115, 0, 'config', 'config_password', '1', 0),
(5116, 0, 'config', 'config_encryption', '1f69fb608d78fb6444bf75e7d695d58c', 0),
...
(5122, 0, 'correios', 'correios_postcode', '09560260', 0),
...
(1, 1, 'admin', '425720718ba2c51f1b1a1ea2b9301047cf4c818f', '08133a027', '', '', 'fernando.mendes@webca.com.br', '', '127.0.0.1', 1, '2015-04-06 04:19:12');
...
--
ALTER TABLE `oc_banner_image`
MODIFY `banner_image_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=365;
--
...
--
ALTER TABLE `oc_setting`
MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5137;
--
